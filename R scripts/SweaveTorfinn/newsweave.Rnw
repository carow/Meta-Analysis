...
print(xtable(mytable, caption = paste("Results of the meta-analysis. Includes the the egger's test and the fails-safe number for publication bias testing"),caption.placement = "top"), size ="footnotesize")
@
...
%print(xtable(mytable2, caption = paste("Results of the meta-regression. Test for heterogeneity taking all four continents into account"),caption.placement = "top"), size ="footnotesize")
%@
