...
\centering
<<<<<<< HEAD
\includegraphics{sweave_document_TB-fig2plot}
\caption{This is an example figure, computed and immediately returned.}
\end{figure}

=======
\includegraphics{sweave_document_TB-forestplot}
\caption{Forestplot from the rma model}
\end{figure}

To assess possible publication bias, funnel plots can be used for visualization.
