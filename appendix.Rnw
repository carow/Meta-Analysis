...
<<label = fig:forestplot, echo = FALSE, fig = TRUE, include = FALSE, pdf = TRUE>>=
...
<<label = fig:funnelplot, echo = FALSE, fig = TRUE, pdf = TRUE, include = FALSE>>=
funnel(rma.RE)
@
...
<<label = fig:diagnostics, eval = TRUE, pdf = TRUE, fig = TRUE, echo = FALSE, include = FALSE>>=
...
<<label = fig:forestreg, echo = FALSE, fig = TRUE, include = FALSE, pdf = TRUE>>=
